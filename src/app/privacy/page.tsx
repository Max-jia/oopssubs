...
export default function PrivacyPage() {
  return (
    <main className="min-h-screen max-w-md mx-auto px-6 py-12">
      <Link href="/" className="text-sm text-gray-400 hover:text-gray-600 mb-8 inline-block">← Home</Link>
      <h1 className="text-2xl font-bold mb-8">Privacy</h1>

      <div className="space-y-6 text-sm text-gray-600 leading-relaxed">
        <section>
          <h2 className="text-base font-semibold text-gray-900 mb-2">We don&apos;t have a server.</h2>
        ...
        <section>
          <h2 className="text-base font-semibold text-gray-900 mb-2">What we access</h2>
        ...
        <section>
          <h2 className="text-base font-semibold text-gray-900 mb-2">You can revoke access anytime</h2>
